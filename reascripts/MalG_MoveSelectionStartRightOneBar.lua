--[[
  Reaper Script to move the left edge of the time selection to the next Bar boundary. 


  Author : Malcolm Groves
  Repo : github.com/malcolmgroves/reaper_csi
]]
function move_time_sel_start_one_bar_right()
...
reaper.defer(move_time_sel_start_one_bar_right)
